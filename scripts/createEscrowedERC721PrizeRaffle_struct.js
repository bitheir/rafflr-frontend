...
const NFT_ADDRESS = "YOUR_ERC721_NFT_ADDRESS";
...
async function main() {
    ...
    if (!ethers.isAddress(NFT_ADDRESS)) throw new Error("Set NFT_ADDRESS");
    const raffleDeployer = await ethers.getContractAt("RaffleDeployer", RAFFLE_DEPLOYER_ADDRESS);

    const params = {
        name: "Escrowed ERC721 Prize Raffle",
    ...
    console.log("New escrowed ERC721 prize raffle at:", event.args.raffle);
}
